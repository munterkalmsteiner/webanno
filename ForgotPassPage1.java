 ...
 */
//@MountPath("/forgotpasspage.html")

public class ForgotPassPage1
    extends ApplicationPageBase
{
        ...
        extends Form<User>
    {
        ...
        public DetailForm(String id, IModel<User> aModel)
        {
           ...
           // add(new ListMultipleChoice<>("roles", getRoles()).add(this::validateRoles)
                 //   .add(visibleWhen(ForgotPassPage.this::isAdmin)));

           // add(new CheckBox("enabled").add(this::validateEnabled)
                 //   .add(visibleWhen(ForgotPassPage.this::isAdmin))
                   // .setOutputMarkupPlaceholderTag(true));

            add(new LambdaAjaxButton<>("save", ForgotPassPage1.this::actionSave));

            add(new LambdaAjaxLink("cancel", ForgotPassPage1.this::actionCancel));
        }
    ...
    public ForgotPassPage1(final PageParameters aPageParameters)
    {
