...
import de.tudarmstadt.ukp.clarin.webanno.ui.core.users.ForgotPassPage1;
    ...
    extends WicketBootSecuredWebApplication
{
    ...
    protected void initDefaultPageMounts()
    {
       ...
       // mountPage("/forgotpass.html", getForGotPassPageClass());
    ...
    public Class<? extends WebPage> getForGotPassPageClass()
    {
        return ForgotPassPage1.class;
    }
